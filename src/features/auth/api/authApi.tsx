...
export const authApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    login: builder.mutation<AuthResponse, LoginCredentials>({
      ...
      transformResponse: (response: any) => {
        ...
        return {
          ...
          role: response.role,
          hasUpdatedPassword: response.hasUpdatedPassword,
    ...
    // Password endpoints
    generateResetToken: builder.mutation<{ message: string }, string>({
      query: (username) => ({
    ...
    confirmResetToken: builder.mutation<{ valid: boolean; token?: string }, { token: string; username: string }>({
