...
export const PredictionsPageHeader: React.FC<PredictionsPageHeaderProps> = ({ 
  ...
  const getSubtitle = () => {
    ...
    return `Welcome ${firstName}! Manage your machine learning predictions and analytics.`;
  };
    ...
    <Box sx={{ mb: 4 }}>
      <Box sx={{
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Tooltip title="Refresh predictions data">
            <IconButton 
...
export default PredictionsPageHeader;